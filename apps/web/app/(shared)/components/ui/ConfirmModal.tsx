...
export default function ConfirmModal({
  ...
  const themes = {
    ...
    emerald:
      "from-emerald-600 to-emerald-700 hover:from-emerald-500 hover:to-emerald-600 border-emerald-500/40 text-emerald-400 font-iosevka-bold",
    blue: "from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 border-blue-500/40 text-blue-400 font-iosevka-bold",
    orange:
      "from-orange-600 to-orange-700 hover:from-orange-400 hover:to-orange-500 border-orange-500/40 text-orange-400 font-iosevka-bold",
    purple:
      "from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 border-purple-500/40 text-purple-400 font-iosevka-bold",
  ...
  return (
    <Modal isOpen={isOpen} onClose={onCancel} maxWidth="max-w-sm">
      <div className="flex flex-col items-center text-center space-y-6">
        <div
          className={`w-16 h-16 bg-gray-900 rounded-full flex items-center justify-center ${theme.split(" ")[2]} mb-2 shadow-inner ring-4 ring-gray-700/50`}
        >
